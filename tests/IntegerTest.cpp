...
TEST_F(IntegerTest, multiply) {
	EXPECT_EQ(Integer(1) * Integer(2), Integer(2));
	EXPECT_EQ(Integer(3) * Integer(4), Integer(12));
	EXPECT_EQ(Integer(-5) * Integer(6), Integer(-30));
	EXPECT_EQ(Integer(7) * Integer(-8), Integer(-56));
	EXPECT_EQ(Integer(-9) * Integer(-10), Integer(90));
	EXPECT_EQ(Integer(-11) * Integer(0), Integer(0));
	EXPECT_EQ(Integer(0) * Integer(12), Integer(0));

	EXPECT_EQ(Integer("4294967296") * Integer("4294967296"), Integer("18446744073709551616"));
	EXPECT_EQ(Integer("-4294967295") * Integer("4294967296"), Integer("-18446744069414584320"));
	EXPECT_EQ(Integer("-4294967295") * Integer("-4294967295"), Integer("18446744065119617025"));

	EXPECT_EQ(Integer("18446744073709551616") * Integer("18446744073709551616"),
			  Integer("340282366920938463463374607431768211456"));
	EXPECT_EQ(Integer("18446744073709551615") * Integer("-18446744073709551616"),
			  Integer("-340282366920938463444927863358058659840"));
	EXPECT_EQ(Integer("-18446744073709551615") * Integer("-18446744073709551615"),
			  Integer("340282366920938463426481119284349108225"));

	EXPECT_EQ(Integer("36893488147419103232") * Integer("-36893488147419103232"),
			  Integer("-1361129467683753853853498429727072845824"));

	EXPECT_EQ(Integer("9123456789012345678901234567890") * Integer("9123456789012345678901234567888"),
			  Integer("83237463780975461056972717573564289285209477213842072549916320"));
	EXPECT_EQ(Integer("-9123456789012345678901234567890") * Integer("-9123456789012345678901234567888"),
			  Integer("83237463780975461056972717573564289285209477213842072549916320"));
	EXPECT_EQ(Integer("-9123456789012345678901234567890") * Integer("9123456789012345678901234567888"),
			  Integer("-83237463780975461056972717573564289285209477213842072549916320"));
